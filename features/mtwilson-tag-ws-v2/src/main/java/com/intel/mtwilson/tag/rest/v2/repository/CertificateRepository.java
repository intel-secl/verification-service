...
//            log.debug("Certificate ID or subject must be specified");
//            return null;
//        }
//        
//        try (CertificateDAO dao = TagJdbi.certificateDao()) {
//            if (locator.pathId != null) {
//                Certificate obj = dao.findById(locator.pathId);
//                if (obj != null)
//                    return obj;
...
//                Certificate obj = dao.findLatestBySubject(locator.subjectEqualTo.toLowerCase());
//                if (obj != null)
//                    return obj;
//            }
//        } catch (Exception ex) {
//            log.error("Error during certificate retrieval", ex);
...
//                dao.insert(item.getId(), newCert.getCertificate(), newCert.getSha1().toHexString(), newCert.getSha256().toHexString(), newCert.getSubject(), 
//                        newCert.getIssuer(), newCert.getNotBefore(), newCert.getNotAfter());                
