...
MTWILSON_SETUP_TASKS=${MTWILSON_SETUP_TASKS:-"create-certificate-authority-key create-flavor-signing-certificate create-default-flavorgroups jetty-ports jetty-tls-keystore password-vault shiro-ssl-port sign-existing-unsigned-flavors"}
